...
const realEstateChildren: TreeNode[] = [
    { indicatorName: "销售面积", nodeId: "RE_SALE_AREA", hasChildren: 0, indicatorCode: "RE_SALE_AREA", parentCode: "RE", levelCode: "2", orderNum: 1, isEndCatalog: 1 },
    { indicatorName: "新开工面积", nodeId: "RE_NEW_START", hasChildren: 0, indicatorCode: "RE_NEW_START", parentCode: "RE", levelCode: "2", orderNum: 2, isEndCatalog: 1 },
];

// --- 模拟的“GDP”子节点数据 ---
const gdpChildren: TreeNode[] = [
    { indicatorName: "第一产业GDP", nodeId: "GDP_PRIMARY", hasChildren: 0, indicatorCode: "GDP_P", parentCode: "GDP", levelCode: "3", orderNum: 1, isEndCatalog: 1 },
    { indicatorName: "第二产业GDP", nodeId: "GDP_SECONDARY", hasChildren: 0, indicatorCode: "GDP_S", parentCode: "GDP", levelCode: "3", orderNum: 2, isEndCatalog: 1 },
    { indicatorName: "第三产业GDP", nodeId: "GDP_TERTIARY", hasChildren: 0, indicatorCode: "GDP_T", parentCode: "GDP", levelCode: "3", orderNum: 3, isEndCatalog: 1 },
];
// --- 模拟的“产品产量和消费量”子节点数据 ---
